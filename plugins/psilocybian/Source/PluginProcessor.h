...
class SpecraumAudioProcessor : public juce::AudioProcessor
{
public:
    ...
    SpecraumAudioProcessor();
    ~SpecraumAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SpecraumAudioProcessor)
};
